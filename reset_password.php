<?php
	if(isset($_POST["reset-password"])) {
		$conn = mysqli_connect("localhost", "root", "tiger", "cab_hiring");
		$sql = "UPDATE `cab_hiring.`usersignup` SET `password` = '" . md5($_POST["member_password"]). "' WHERE `usersignup`.`username` = '" . $_GET["name"] . "'";
